...
public class LogWriter 
{
    ...
    private LogWriter()
    {
        pentahoLogger = LoggerFactory.getLogger(STRING_PENTAHO_DI_LOGGER_NAME);
...
//            pentahoLogger.removeAllAppenders();
    ...
    //
        ...
        switch(logLevel)
        {
        case ERROR:    pentahoLogger.error(logMessage.getMessage(), logMessage.getArguments()); break;
        case ROWLEVEL: 
        case DEBUG:    pentahoLogger.debug(logMessage.getMessage(), logMessage.getArguments()); break;
        default:       pentahoLogger.info(logMessage.getMessage(), logMessage.getArguments()); break;
        }
	}
